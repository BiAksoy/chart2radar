...
For Streamlit Cloud deployment, it automatically runs the Streamlit app.
For local usage, you can use it to launch the app or run tests.
...
if 'STREAMLIT_SERVER_PORT' in os.environ or len(sys.argv) == 1:
    # Running in Streamlit Cloud or no arguments - run the Streamlit app
    import subprocess
    ...
    # Running locally with arguments - use the original launcher functionality
    import argparse
    import subprocess
    ...
    def main():
        """Main entry point for local usage."""
